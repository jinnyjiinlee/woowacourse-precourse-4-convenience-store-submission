...
const NORMAL_PRODUCT_AMOUNT = {
  COKE: Number(productAmount[1][2]),
  SPRITE: Number(productAmount[3][2]),
  WATER: Number(productAmount[6][2]),
  VITAMIN_WATER: Number(productAmount[7][2]),
  POTATO_CHIP: Number(productAmount[9][2]),
  CHOCOLATE_BAR: Number(productAmount[11][2]),
  ENERGY_BAR: Number(productAmount[12][2]),
  PACKED_LUNCH: Number(productAmount[13][2]),
  CUP_RAMEN: Number(productAmount[15][2]),
};

const PROMOTION_PRODUCT_AMOUNT = {
  COKE: Number(productAmount[0][2]),
  SPRITE: Number(productAmount[2][2]),
  ORANGE_JUICE: Number(productAmount[4][2]),
  SPARKLING_WATER: Number(productAmount[5][2]),
  POTATO_CHIP: Number(productAmount[8][2]),
  CHOCOLATE_BAR: Number(productAmount[10][2]),
  CUP_RAMEN: Number(productAmount[14][2]),
};
