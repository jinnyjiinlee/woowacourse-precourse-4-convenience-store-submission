...
- [ ]  영수증을 출력한다.
    - [ ] 사용자가 구매한 상품명이 나온다.
    - [ ] 사용자가 구매한 상품에 대한 수량이 나온다.
    - [ ] 사용자가 구매한 상품명과 수량에 맞는 금액이 나온다.
    - [ ] 사용자가 구매한 상품 중 프로모션 상품이 있다면 프로모션 상품의 상품명이 나온다.
    - [ ] 사용자가 구매한 상품 중 프로모션 상품이 있다면 프로모션 상품의 수량이 나온다.

    - [ ] 사용자가 구매한 모든 상품의 총 수량을 더한 값이 나온다.
    - [ ] 사용자가 구매한 프로모션 상품의 수량에 따른 가격이 행사할인 가격으로 나온다.
    - [ ] 사용자가 받는 맴버십 할인 금액 나온다. 
    - [ ] 총구매액에서 '행사할인', '맴버십할인'의 금액을 차감한 '내실돈'금액이 나온다.
